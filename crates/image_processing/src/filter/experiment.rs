//! Some different convolution implementations tried out to test their performance behaviors.
        ...
        XConvMethod::Test1 => {
            for _ in 0..REPETITIONS {
                ...
                sobel_x_conv_test_1(
                    padded_width,
                    &padded_bytes,
                    // In parallel version we'll take slice of output as last arg and
